...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Category::create(['name' => 'categories.man_team', 'gender' => 'M', 'isTeam' => 1,'ageCategory' => 0]);
        Category::create(['name' => 'categories.woman_team', 'gender' => 'F', 'isTeam' => 1,'ageCategory' => 0]);
        Category::create(['name' => 'categories.mixed_team', 'gender' => 'X', 'isTeam' => 0,'ageCategory' => 0]);
