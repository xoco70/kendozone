...
!function (a, b, c, d) {
    ...
    e.prototype = {
        ...
        setBootstrap2Compatible: function (a, b) {
            return this.settings.bootstrap2Compatible = a, a ? (this.container.removeClass("row").addClass("row-fluid bs2compatible"), this.container.find(".box1, .box2").removeClass("col-md-6").addClass("span6"), this.container.find(".clear1, .clear2").removeClass("btn-default").addClass("btn-mini"), this.container.find("input, select").removeClass("form-control"), this.container.find(".btn").removeClass("btn-default"), this.container.find('.moveall > i').removeClass('icon-last').addClass('icon-last'), this.container.find('.move > i').removeClass('icon-forward3').addClass('icon-forward3'), this.container.find('.removeall > i').removeClass('icon-first').addClass('icon-first'), this.container.find('.remove > i').removeClass('icon-backward2').addClass('icon-backward2')) : (this.container.removeClass("row-fluid bs2compatible").addClass("row"), this.container.find(".box1, .box2").removeClass("span6").addClass("col-md-6"), this.container.find(".clear1, .clear2").removeClass("btn-mini").addClass("btn-default"), this.container.find("input, select").addClass("form-control"), this.container.find(".btn").addClass("btn-default"), this.container.find('.moveall > i').removeClass('icon-last').addClass('icon-last'), this.container.find('.move > i').removeClass('icon-forward3').addClass('icon-forward3'), this.container.find('.removeall > i').removeClass('icon-first').addClass('icon-first'), this.container.find('.remove > i').removeClass('icon-backward2').addClass('icon-backward2')), b && k(this), this.element
        },
            ...
            return this.each(function () {
                ...
                if (settings.useSelect) {
                    ...
                    if (settings.disableTextInput) {
                        self.on('keydown.timepicker', function (e) {
                            e.preventDefault();
                        });
                    }
