    ...
    <div class="container">
        <div class="row col-md-12 custyle">
            <table class="table table-striped custab">
                <thead>
                <a href="{!!   URL::action('FederationController@create') !!}" class="btn btn-primary btn-xs pull-right"><b><i class="icon-plus22 mr-5" ></i></b> @lang('crud.addModel', ['currentModelName' => $currentModelName])</a>
                <tr>
                    <th>ID</th>
                ...
                @foreach($federations as $federation)
                    <tr>
                        ...
                        <td class="text-center">
                            <a class='btn btn-info btn-xs' href="{!!   URL::action('FederationController@edit',  $federation->id) !!}">
                                <span class="glyphicon glyphicon-edit"></span> {{ trans('crud.edit') }}</a>
                            <a class="btn btn-danger btn-xs"
                               href="{!! URL::action('FederationController@destroy',  $federation->id) !!}" data-method="delete" data-token="{{csrf_token()}}">
                                <span class="glyphicon glyphicon-remove"></span> {{ trans('crud.delete') }}</a>
                        </td>
                    </tr>
                            <a href="{{url('federations', $federation->id)}}"> </a></h2>
